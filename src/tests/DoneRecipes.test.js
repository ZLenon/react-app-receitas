...
// TESTES não estão passando por não ter o localStorage da pág DoneRecipes ainda.
// Quando estiverem prontas as pág anteriores testes passarão
...
describe('Verifica tela de Receitas Feitas', () => {
  ...
  it('Testa a renderização dos componentes DoneRecipes', async () => {
    await act(async () => renderWithRouter(
      <DoneRecipes />,
      { initialEntries: [path] },
    ));
